                        ...
                        <div class="p-4 shadow rounded-lg bg-gray-700 text-gray-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold">{{ lockers.filter(l => l.status === 'online').length }}</p>
                                </div>
                        ...
                        <div class="p-4 shadow rounded-lg bg-gray-700 text-gray-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold">{{ lockers.filter(l => l.status === 'offline').length }}</p>
                                </div>
                        ...
                        <div class="lg:col-span-1 bg-gray-700 rounded-lg shadow p-4">
                            ...
                            <div class="relative h-[400px] rounded-lg overflow-hidden bg-gray-800">
                                <div v-if="!mapLoaded" class="absolute inset-0 flex items-center justify-center">
                                    <div class="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#38a3a5]">
                                    </div>
                                </div>
                    ...
                    <div class="bg-gray-700 rounded-lg shadow p-4 mb-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <div class="flex gap-2">
                                <button @click="fetchExcelData" class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded shadow">
                                    Refresh Excel Data
                                </button>
                                <a href="/qubedashboard/login" class="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded shadow">
                            ...
                            <table class="min-w-full bg-gray-800 text-gray-200 rounded-lg overflow-hidden">
                                <tbody>
                                    <tr v-for="(row, rowIndex) in excelData" :key="rowIndex">
                                        <td v-for="(cell, colIndex) in row" :key="colIndex" class="py-2 px-4 border border-gray-700">
                                            {{ cell }}
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="min-w-full bg-gray-800 text-gray-200 rounded-lg overflow-hidden">
                                ...
                                <tbody>
                                    <tr class="border-t border-gray-700">
                                        ...
                                        <td class="py-3 px-4"><span class="bg-green-500/20 text-green-500 py-1 px-2 rounded">Completed</span></td>
                                    </tr>
                                    <tr class="border-t border-gray-700">
                                    ...
                                    <tr class="border-t border-gray-700">
                                        ...
                                        <td class="py-3 px-4"><span class="bg-yellow-500/20 text-yellow-500 py-1 px-2 rounded">In Progress</span></td>
                                    </tr>
                                    <tr class="border-t border-gray-700">
                                        ...
                                        <td class="py-3 px-4"><span class="bg-red-500/20 text-red-500 py-1 px-2 rounded">Pending</span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
